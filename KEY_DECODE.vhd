...
U1 : KEY_CONTROL port map(	Kack => Kack, Kpress => carry_Kpress, CLK => CLK, RESET => RESET, 
									Kscan => carry_Kscan, Kval => Kval);

U2 : KEY_SCAN 	port map(	Kscan => carry_Kscan, CLK => CLK, Reset => RESET, lin0 => LIN(0), lin1 => LIN(1),
